...
class Category(models.Model):
	...
	featured_image = FileBrowseField("Image", max_length=200, directory="uploads/", extensions=[".jpg", ".jpeg"], blank=True)
	thumb_image = FileBrowseField("Image", max_length=200, directory="uploads/", extensions=[".jpg", ".jpeg"], blank=True)
